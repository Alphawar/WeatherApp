...
const Loader = () => {
    return(
        <div className={classes.preloader} style={{opacity: 1}}>
  <svg className={classes.svg} version="1.1" id="cloud" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="10px" height="10px" viewBox="0 0 10 10" enableBackground="new 0 0 10 10" xmlSpace="preserve">
